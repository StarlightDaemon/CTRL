...
Features:
- **Modern UI**: Clean, professional design with Dark Mode and Low Power themes.
- **Quick Action Popup**: Check status, test connection, and toggle servers directly from the toolbar.
